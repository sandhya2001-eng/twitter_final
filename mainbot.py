...
while True:
    user = api.get_user('SANDHYA10785193')
    api.update_profile(name=f'sandhya|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : sandhya|{follower_count(user)} Followers')
